...
_DASH_SIGNALS = {
    # Risk & Controls
    "kri":          ["kri","risk indicator","key risk","uk-k","sg-k","cep-k","risk_id"],
    "scorecard":    ["scorecard","kpi","performance","metric","measure"],
    "compliance":   ["control","compliance","breach","audit","regulation","sox","policy"],
    # Finance
    "sales":        ["revenue","sales","pipeline","quota","deal","opportunity","customer","arr","mrr"],
    "finance":      ["p&l","budget","forecast","variance","actual","cost","expense","profit","margin"],
    "ops":          ["sla","incident","ticket","ops","operation","uptime","latency","throughput"],
    # Data Quality
    "data_quality": ["data quality","dq","dcrm","cde","completeness","accuracy","validity","timeliness"],
    # General analytics
    "hr":           ["headcount","employee","hire","attrition","turnover","workforce","fte"],
    "marketing":    ["campaign","impression","click","conversion","cpc","cpm","roi","channel"],
    "supply_chain": ["inventory","supplier","lead time","fulfillment","shipment","logistics","warehouse"],
    "it":           ["server","cpu","memory","disk","network","latency","error rate","availability"],
    # Catch-all
    "generic":      [],
}
